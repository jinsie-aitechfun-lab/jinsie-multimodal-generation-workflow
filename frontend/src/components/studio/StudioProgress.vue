...
:root[data-theme="pearl"] .studio-progress {
...
:root[data-theme="pearl"] .studio-progress__pct {
  color: rgba(138, 112, 64, 0.72);
}

:root[data-theme="pearl"] .studio-progress__label {
  color: rgba(111, 106, 95, 0.68);
}

:root[data-theme="pearl"] .studio-progress--complete .progress-fill {
